          ...
          <View className="flex-row items-center justify-between p-4 border-b border-border">
            <View className="flex-row items-center gap-3">
              ...
              <View>
                ...
                <Text className="text-muted text-xs font-manrope">Toujours activée pour votre sécurité</Text>
              </View>
            </View>
            <View className="bg-surface-hover px-3 py-1 rounded-full">
              <Text className="text-primary text-xs font-manrope-bold">Toujours Activée</Text>
            </View>
          </View>
